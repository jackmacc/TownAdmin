...
public class swiper_news_list_Activity extends AppCompatActivity   implements SwipeRefreshLayout.OnRefreshListener {

   // public static final String API_KEY =   "67ff7df4cd0d460fb0cc29221554d186";
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private List<townArticle> articles = new ArrayList<>  ();

    private swiper_news_Adapter newsAdapter;
    private String TAG =    swiper_news_list_Activity.class.getSimpleName();
...
//底部
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()){
                ...
                case R.id.swiper_new_product_add:
                    intent.setClass(getApplicationContext(), swiper_news_AddEdit_Activity.class);
                    //addswitch =new
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.swipernews_activity_news_list);




        hiddenActionBar(swiper_news_list_Activity.this);
        ...
        //窗口管理器
        layoutManager = new LinearLayoutManager  (swiper_news_list_Activity.this);
    ...
    public void LoadJson(final String keyword) {
        ...
        if (keyword.length() > 0) { //搜索的 关键字
            ...
            call = apiInterface.getTownNews_swiper("");
        ...
        call.enqueue(new Callback<townNews>() {//download 获取网上的资源  retrofit 工具
            ...
            public void onResponse(Call<townNews> call,   Response<townNews> response) {
                ...
                if (response.isSuccessful() &&  response.body().getArticles() != null) {
                    ...
                    //【第一步】 将数据给适配器显示列表
                    //新闻适配器
                    newsAdapter = new swiper_news_Adapter(articles,  swiper_news_list_Activity.this);
                 ...
                 //   topHeadline.setVisibility  (View.VISIBLE);
                    ...
                    //
                    //
                    Toast.makeText(swiper_news_list_Activity.this, "没得到需要新闻结果返回!", Toast.LENGTH_LONG).show();
    ...
    private void initListener() {
        ...
        newsAdapter.setOnItemClickListener(new swiper_news_Adapter.OnItemClickListener() {
            @Override
            ...
            public void from_onClick_get_pos_to_process(View view, int  position) {//两个参数,来自 holder 对象的点击事件
                ...
                Intent intent = new Intent   (swiper_news_list_Activity.this, swiper_news_detail_Activity.class);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if (query.length() > 2) {
                    ...
                    Toast.makeText(swiper_news_list_Activity.this,
