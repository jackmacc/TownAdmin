...
import static com.jackmacc.townadmin.Tool.Utils.DateFormat;
...
public class news_Adapter extends RecyclerView.Adapter<news_Adapter.MyViewHolder> {
    ...
    //适配器用魔术指针处理  引用数据
    public news_Adapter(List<townArticle> articles, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(context).inflate//获取布局的视图
                (R.layout.news_adapter_item,parent,false);
    ...
    //    holder.source.setText(model_Item.getSource().getName());
        holder.release_date.setText(DateFormat(model_Item.getNews_date()));
